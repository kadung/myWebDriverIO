...
module.exports = {
    ...
    **/
    /****************************************************************************************/
    getTableRow : function (fileName, sheetName, columnName, where, callback){
        xls_json(fileName, {
    ...
    **/
    /****************************************************************************************/
    getTableRows : function (fileName, sheetName, callback){
    xls_json(fileName, {
        'convert_all_sheet': false,
        'return_type': 'Object',
        'sheetName': sheetName
    ...
    **/
    /****************************************************************************************/
    getAllSheetData : function (fileName, callback){
    xls_json(fileName, {
